...
def read_parser():
        ...
        def general_training_args(required_train, optional_train):
        	...
        	required_train.add_argument('-d', '--data-type', required=True, type=str, choices=['ATAC', 'DNASE', 'ACCESS'], help="assay type")
        ...
        required_qc_parser.add_argument('-d', '--data-type', required=True, type=str, choices=['ATAC', 'DNASE', 'ACCESS'], help="assay type")
       ...
       # bias model qc arguments
        ...
        required_bqc_parser.add_argument('-d', '--data-type', required=True, type=str, choices=['ATAC', 'DNASE', 'ACCESS'], help="assay type")
